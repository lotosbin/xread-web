...
import {QueryResult, Subscription} from "react-apollo";
...
const Home = ({location: {pathname, search}}: any) => {
    ...
    articleAdded {
        ...
        tags
                ...
                {({data: {articleAdded} = {articleAdded:null}, loading}: any) => {
                    return articleAdded ? <h4>New article: {!loading && articleAdded.title}</h4> : null;
                }}
            </Subscription>
            <div>
